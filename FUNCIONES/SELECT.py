...
class SELECT(Instruccion):        
    ...
    def ejecutar(self, actual, globa, ast):
        ...
        try:
                                ...
                                for expr in lista_expresiones: #OBTIENE LOS VALORES DE LAS EXPRESIONES Y LAS GUARDA EN LISTAS
                                    ...
                                    if(tipo_expr == TIPO.COLUMNA):                                      #ES COLUMNA
                                        ...
                                        if(valor_expr!=None):
                                            ...
                                            ast.insertar_error_semantico(ERROR_LSS("SEMANTICO","NO existe la columna "+str(expr.nombre_columna) +" en la tabla "+str(expr.nombre_tabla)+"!",self.linea))
                                    else:           
                    ...
                    if(valor_where != None):
                        if(len(valor_from) >= 1 and len(valor_where) >= 1):
                            ...
                            if(validaciones == None):       #SI WHERE ES NONE ES PORQUE HUBO UN ERROR
                                ...
                                ast.insertar_error_semantico(ERROR_LSS("SEMANTICO","SELECT: Se encontro un error en el where",self.linea))
                                return 
            ...
            ast.escribir_en_consola("("+str(self.linea)+")"+"ERROR: Hubo un error en el select.\n")
            ast.insertar_error_semantico(ERROR_LSS("SEMANTICO","Hubo un error en el select",self.linea))
