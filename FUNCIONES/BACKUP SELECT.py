...
class SELECT(Instruccion):        
    ...
    def ejecutar(self, actual, globa, ast):
        #print(self.text)
        salida = ""
        lista_respuestas_select = []    #[[nombre_tabla,[1,2,3]],[nombre_tabla,[1,2,3]]]  
        if(isinstance(ast, AST)):
            ...
            ''' 1) EJECUTAR TODOS LOS SELECT
                2) EJECUTAR EL WHILE
                3) RECORRER EL FROM, OBTENER LA RESPUESTA DE CADA SELECT 
                4) OBTENER LA RESPUESTA DEL WHERE Y AGREGAR A LA SALIDA LAS POSICIONES VALIDAS DE LAS RESPUESTAS
            '''
